...
export const StartMenu = ({
  ...
  return (
    <>
      <div className="z-[1] absolute left-0 bottom-0 w-[130px] h-[60px] cursor-pointer" />
      <OutsideClickHandler onOutsideClick={handleStartMenu}>
        <div className="z-[1] absolute bottom-[60px] left-0 pl-[50px] h-[500px] w-[350px] bg-[#c3c3c3] border-t-[2.5px] border-l-[2.5px] border-r-[2.5px] border-b-[2.5px] border-t-white border-l-white border-r-black border-b-black">
